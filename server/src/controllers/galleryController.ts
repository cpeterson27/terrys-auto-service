...
export const readGalleryUploadFiles = (req: AuthRequest, res: Response, next: NextFunction) => {
...
export const listPublicGalleryItems = async (_req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
export const listGalleryItems = async (_req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
export const addGalleryItemMedia = async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
    const uploadedFiles = getUploadedFiles(req);
